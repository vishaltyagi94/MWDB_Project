...
if arg == '1':
    inp = input("Would you like to save SIFT features or Moment features (s/m/l/h)?")
    ...
    rec = ip.dbProcess(password='password', model=inp1, all='n', imgid=inp, process='f')
    ...
    recs = ip.dbProcess(password='password', model=inp1, process='f')
